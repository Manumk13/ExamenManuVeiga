 ...
 * @author cice
 */
public class ConsultaLibrosServlet2 extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ResultSet libros = gl.getLibros();
            System.out.println("TODO CORRECTOO");
            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/Consultar.jsp");
